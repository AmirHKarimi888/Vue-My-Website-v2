  ...
  <div class="about">
    ...
    <ul class="links mx-auto mt-28 w-[330px] grid grid-cols-1 gap-3">
        <li 
          ...
          class="shadow-lg border border-gray-400 dark:border-gray-600 rounded-lg bg-white dark:bg-slate-800 text-gray-700 dark:text-white flex grid-cols-2 gap-7">
